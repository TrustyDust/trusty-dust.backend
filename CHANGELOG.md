...
- Added rate limiting via `@nestjs/throttler` for `/auth/login` (5 req/min), social interactions (20–60 req/min tiers), wallet reputation analysis (10 req/5 min), `/zk/generate` (5 req/min), and the jobs creation/apply/submit/confirm flows (10–30 req/5 min) to prevent abuse.
